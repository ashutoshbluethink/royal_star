...
class ForgotPasswordController extends Controller
{
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        $cc = "";
		$emailContent = "<!DOCTYPE html><html><head><title>Contact Form Submission</title></head>
						<body><h1>Click here to change your password</h1><a href='https://lead.bluethinkinc.com/reset/".$rand_id."'>Click here to reset password</a></body></html>";
        ...
        if(isset($userEmail[0])){
			...
			SendMail::sendMail($emailContent, 'Forget Password', $emailAddress, 'noreply@mybluethink.in', $cc);
