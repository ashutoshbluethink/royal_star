...
<!-- <div class="row">
    @php
        // Array of pastel background colors for visual variety
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <a href="{{ route('user.leads.show', ['userId' => $user->user_id]) }}">
                <div class="dash-widget dash-widget5" 
                     style="background-color: {{ $backgroundColors[$colorIndex % count($backgroundColors)] }};">
...
<div class="row">
    @php
        // Distinct pastel backgrounds for Lead Support cards
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <a href="{{ route('user.leads.show', ['userId' => $user->user_id]) }}">
                <div class="dash-widget dash-widget5" 
                    ...
                    {{-- User Avatar/Profile Image with Lead Support Badge --}}
