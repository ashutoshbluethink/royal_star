							...
							<div class="card-body">
                                    ...
                                    <form action="{{ route('update.role') }}" method="POST" enctype="multipart/form-data">
                                     @csrf
                                        ...
                                        <input type="hidden" class="form-control" value="{{$editRole->role_id}}" placeholder="Enter the role name" name="role_id">
                                            <label>Role Name</label>
                                            <input type="text" class="form-control" value="{{$editRole->role_name}}" placeholder="Enter the role name" name="role_name" id="role_name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="role_status">
                                                <option value="1" {{$editRole->role_status == '1' ? 'selected' : ''}}>Active</option>
                                                <option value="0" {{$editRole->role_status == '0' ? 'selected' : ''}}>Inactive</option>
                                            </select>
                                        </div>
                                       
                                        <div class="form-group text-center custom-mt-form-group">
                                            <button class="btn btn-primary mr-2" type="submit" name="submit">Update Role</button>
